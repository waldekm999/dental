...
--
-- Host: 127.0.0.1
-- Czas generowania: 15 Mar 2019, 18:27
...
(1, 'Radosław', 'szczepanska.klara@onet.pl', NULL, '$2y$10$TbSEqoLwQlRkVNZdEm.2Su93Mr0RFzPe9VKFFmolS9bVwyooU1nZu', NULL, '2019-03-02 11:25:00', '2019-03-02 11:25:00', 'Urbański', '91234419643', '0048 913 067 884', 'patient', 'Kraków', '31-956', 'Głowackiego Bartosza 77A', NULL, NULL),
(2, 'Tomasz', 'kowalska.mariusz@gazeta.pl', NULL, '$2y$10$2HaA8q1Sltvs2kWZx.3NYOZuYtL77eln7I/GcC8vkbYhwrqEsg1ay', NULL, '2019-03-02 11:25:00', '2019-03-02 11:25:00', 'Lis', '63648581605', '0048(82)0844915', 'patient', 'Lubin', '30-609', 'Niepodległości 44A/40', NULL, NULL),
...
(5, 'Anna', 'patryk.zalewski@kubiak.net', NULL, '$2y$10$YqOnbr0GVbvb81zAUMO61e3y9.tSg/FiJQHNpbDTrrVGVN0raEPue', NULL, '2019-03-02 11:25:01', '2019-03-02 11:25:01', 'Andrzejewska', '46283622315', '+48 436 025 106', 'patient', 'Dzierżoniów', '46-068', 'Południowa 48A/91', NULL, NULL),
(6, 'Fabian', 'ikwiatkowski@onet.pl', NULL, '$2y$10$Pcj7DPn6S1R6jjxC2BIk0eXYqgmqpRbDhWmf/J46IzgJWvo03O/HO', NULL, '2019-03-02 11:25:01', '2019-03-02 11:25:01', 'Czarnecka', '99569107347', '0048 06 017 70 97', 'patient', 'Otwock', '88-902', 'Legnicka 02A', NULL, NULL),
...
(68, 'Daniel', 'mroz.aleksandra@onet.pl', NULL, '$2y$10$2D3L6D0du.dlgEIbL11OAuBVqgC1h5XBKIMdE/2h5sPmNsaLPiJXm', NULL, '2019-03-02 11:25:05', '2019-03-02 11:25:05', 'Brzezińska', '77756035821', '0048(01)0646008', 'patient', 'Tczew', '25-210', 'Leśna 84/84', NULL, NULL),
...
(96, 'Marcin', 'szymon.olszewski@chmielewski.pl', NULL, '$2y$10$oOJebExm7vSJf/ceYnCLFOlS3O9XyccGg11CR7RtElwA3oBHdKWG.', NULL, '2019-03-02 11:25:07', '2019-03-02 11:25:07', 'Adamski', '21917600070', '0048 49 752 22 61', 'patient', 'Pieszyce', '18-317', 'Rybacka 24', NULL, NULL),
...
(101, 'Łukasz', 'krol.damian@sobczak.pl', NULL, '$2y$10$FGO.gaOGAoU9Fd9JQSkQo.zVxOJBSG2spW23kmGFUsrJCjLjmAUna', NULL, '2019-03-02 11:25:07', '2019-03-02 11:25:07', 'Pietrzak', '63515212940', '+48 446 275 265', 'staff', 'Kamienica Królewska', '94-021', 'Jodłowa 40A/76', 'Węch jego i głowa zarastały wówczas bujnie i dziko siwym włosem, sterczącym nieregularnie. Azaliż szedł tedy na wprost', 'active'),
(102, 'Fabina', 'dsobczak@gmail.com', NULL, '$2y$10$ET.I16MjsPnsrlaEqKV6JOomly0g6DfZS.2JR2ukwMPaPcSTJFfF2', NULL, '2019-03-02 11:25:07', '2019-03-02 11:25:07', 'Ziółkowska', '63499248126', '+48(95)4064510', 'staff', 'Wyszków', '77-147', 'Wąska 49/12', 'Tantalidów, cały smutny i jałowy Olimp, więdnący od lat w tym pustym mieszkaniu. Nalewał do.', 'active'),
(103, 'Michalina', 'wojciech08@tomaszewska.org', NULL, '$2y$10$9wenwzHZ1c3QL1eXbMMy7uPV8MyqOgMOWVhR3V3K0q.HDVK6PD9OS', NULL, '2019-03-02 11:25:07', '2019-03-02 11:25:07', 'Wysocka', '59591848994', '0048 87 976 10 88', 'staff', 'Pułtusk', '80-819', 'Tuwima Juliana 81A/00', 'Ach, ten dziki obłęd popłochu, pisany błyszczącą, czarną linią na tablicy podłogi. Ach, te krzyki.', 'inactive'),
...
INSERT INTO `visits` (`id`, `doctor_id`, `patient_id`, `date`, `created_at`, `updated_at`, `description`, `status`) VALUES
(5, 107, 12, '2019-03-21 13:00:00', NULL, NULL, NULL, 'odwołana'),
(6, 107, 14, '2019-03-04 10:00:00', NULL, NULL, 'To była bardzo udana wizyta', 'wizyta'),
(7, 106, 14, '2019-04-30 10:00:00', NULL, NULL, NULL, 'rezerwacja');
